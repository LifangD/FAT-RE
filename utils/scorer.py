...
def score(key, prediction, verbose=False):
    ...
    for row in range(len(key)):
        ...
        # if gold == "org:number_of_employees/members":
        #     print(guess)
        if gold == guess:
            total_correct +=1
        ...
        if gold == NO_RELATION and guess == NO_RELATION:
            ...
            gold_by_relation[gold] += 1
            if gold == guess:
                correct_by_relation[guess] += 1 # only the no relation number?
    ...
    if verbose:
        ...
        for relation in sorted(relations):
            ...
            # (print the score)
            # if f1<0.1:
            #     guessed_by_relation[relation] =0
            #     gold_by_relation[relation] =0
    ...
    accuracy = total_correct/len(key)
    ...
    if macro:
        ...
        macro_f1 = 2.0 * avg_prec * avg_recall / (avg_prec + avg_recall)
        print ("macro_f1: {:.3%}".format (macro_f1))

    return accuracy,prec_micro, recall_micro, f1_micro
