...
import vocab,constant,helper

def parse_args():
    parser = argparse.ArgumentParser(description='Prepare vocab for relation extraction.')
    parser.add_argument('--data_dir', default='dataset/processed_semeval',help='TACRED directory.')
    parser.add_argument('--vocab_dir', default='vocab',help='Output vocab directory.')
    parser.add_argument('--wv_file', default='glove.6B.50d.txt', help='GloVe vector file.')
    parser.add_argument('--wv_dim', type=int, default=50, help='GloVe vector dimension.')
...
def load_w2v():
    ...
    model = KeyedVectors.load_word2vec_format('/home/dlf/pyprojects/GoogleNews-vectors-negative300.bin', binary=True)
    model.save_word2vec_format('/home/dlf/pyprojects/GoogleNews-vectors-negative300.txt', binary=False)
...
def main():
    ...
    # load files
    print("loading files...")
    train_tokens = load_tokens(train_file) # load sentence token with entity being padding?
