...
def get_optimizer(name, parameters, lr, l2):
    if name == 'sgd':
        return torch.optim.SGD(parameters, momentum=0.95,lr=lr, weight_decay=l2)
        ...
        return torch.optim.Adam(parameters,lr=lr,eps=1e-9,betas=(0.9,0.98),amsgrad=True,weight_decay=l2)
    elif name == 'adamax':
