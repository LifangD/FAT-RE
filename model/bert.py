...
class TacredProcessor(DataProcessor):
    ...
    def get_dev_examples(self, data_dir):
        return self._create_examples (os.path.join (data_dir, "dev.json"), "train")
...
def main():
    ...
    model = BertForSequenceClassification.from_pretrained(args.bert_model, state_dict=model_state_dict,num_labels = 42)
    model.to(device)
